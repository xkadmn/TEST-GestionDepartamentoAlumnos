...
<head>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="/gestiondepartamentoalumnos/css/styleButtonX.css"><!----===== CA01:  ruta estilo boton eliminar pdf e img ===== -->
        ...
        <?php if ($aviso) { ?>
          <form id="formulario">
            ...
            <div class="mb-3">
              ...
              <!----===== CA02 modificar anucio, *3 filtro fecha publicacion ===== -->
              <div class="mb-3">
         ...
         <!----===== CA01 *1 agrega boton de eliminar archivo ===== -->
            <div class="mb-3">
